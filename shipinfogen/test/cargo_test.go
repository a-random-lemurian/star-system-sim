...
func TestLoadCargo(t *testing.T) {
	ship := getTestShip()
	if ship.Cargo.LoadCargo("testing material", 8000) == nil {
		if ship.Cargo.CheckCargo("testing material") != 8000 {
...
func TestLoadCargoWithError(t *testing.T) {
	ship := getTestShip()
	if ship.Cargo.LoadCargo("testing material", 12000) == nil {
...
func TestUnloadCargo(t *testing.T) {
	ship := getTestShip()
	if ship.Cargo.LoadCargo("testing material", 8000) == nil {
		unloaded, err := ship.Cargo.UnloadCargo("testing material", 4000)
		if (ship.Cargo.CheckCargo("testing material") != 4000 &&
...
func TestUnloadCargoWithError(t *testing.T) {
	ship := getTestShip()
	if ship.Cargo.LoadCargo("testing material", 8000) == nil {
		unloaded, err := ship.Cargo.UnloadCargo("testing material", 9000)
